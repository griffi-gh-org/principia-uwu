...
#define SIGNAL_CLICK_DISCOVER       400
#define SIGNAL_CLICK_SANDBOX        401
#define SIGNAL_SAVE_LEVEL           402
#define SIGNAL_PLAY_COMMUNITY_LEVEL 403
#define SIGNAL_MAIN_LEVEL_COMPLETED 404
#define SIGNAL_LITE_SPECIAL_BUTTON  405
